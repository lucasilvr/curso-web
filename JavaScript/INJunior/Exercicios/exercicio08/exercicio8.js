function countBooksInCategory(booksByCategory) {
  ...
  booksByCategory.forEach(category => { //o forEach percorre cada elemento do vetor
    result[category.category] = category.books.length; //conta o numero de elementos do array
  }); //essa parte do código eu achei um pouco complexa
...
let result = countBooksInCategory(booksByCategory);
console.log(result);